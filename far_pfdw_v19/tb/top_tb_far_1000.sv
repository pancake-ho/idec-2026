...
// -----------------------------------------------------------------------------
// 1000-image functional testbench for PFDW V19 FAR.
//
...
module top_tb_far_1000;
    ...
    initial begin
        ...
        $display("============================================================");
        $display(" PFDW V19 FAR 1000-image functional test start");
        ...
        $display("\n============================================================");
        $display(" PFDW V19 FAR Final Accuracy for 1000 Input Images");
    ...
    initial begin
        #25000000; // 25 us
        $display("[PFDW V19 FAR 1000] TIMEOUT at %0t ps", $time);
        $finish;
    end
