...
module top_tb_v20_vs_baseline_1000;
    ...
    initial begin
        ...
        $display("============================================================");
        $display(" Baseline vs PFDW V20 W5: 1000-image comparison");
        ...
        if ((baseline_correct == 970) && (pfdw_correct >= 970) && (xz_count == 0))
            $display(" RESULT: PASS - baseline, V20 accuracy and X/Z gates passed.");
        else
            $fatal(1, "RESULT: FAIL - baseline, accuracy or X/Z regression.");
    ...
    initial begin
        #90000000; // 90 us
        $fatal(1, "[COMPARE 1000] TIMEOUT at %0t ps", $time);
    end
