...
// =============================================================================
module pfdw_pipe49_booth_engine_v20_w5 (
    input  logic clk,
    input  logic rst_n,
    ...
    input  logic signed [4:0]  conv_kernel [0:4][0:4],

    input  logic signed [11:0] fc_a [0:47],
    input  logic signed [4:0]  fc_b [0:47],
    ...
    function automatic logic signed [6:0] g3_h5(
        input logic signed [4:0] x0,
        input logic signed [4:0] x1,
        input logic signed [4:0] x2,
        input integer o
    );
        logic signed [6:0] a0, a1, a2;
        begin
            a0 = {{2{x0[4]}},x0}; a1 = {{2{x1[4]}},x1}; a2 = {{2{x2[4]}},x2};
            case (o)
                0: g3_h5 = a0 <<< 1;
                1: g3_h5 = a0 + a1 + a2;
                2: g3_h5 = a0 - a1 + a2;
    ...
    function automatic logic signed [5:0] g2_h5(
        input logic signed [4:0] x0,
        input logic signed [4:0] x1,
        input integer o
    );
        logic signed [5:0] a0, a1;
        begin
            a0 = {x0[4],x0}; a1 = {x1[4],x1};
            case (o)
                0: g2_h5 = a0;
                1: g2_h5 = a0 + a1;
                default: g2_h5 = a1;
    ...
    function automatic logic signed [6:0] g2_h5_sext7(
        input logic signed [4:0] x0,
        input logic signed [4:0] x1,
        input integer o
    );
    ...
    function automatic logic signed [8:0] g3_v7(
        input logic signed [6:0] x0,
        input logic signed [6:0] x1,
        input logic signed [6:0] x2,
        input integer o
    );
        logic signed [8:0] a0, a1, a2;
        begin
            a0 = {{2{x0[6]}},x0}; a1 = {{2{x1[6]}},x1}; a2 = {{2{x2[6]}},x2};
            case (o)
                0: g3_v7 = a0 <<< 1;
                1: g3_v7 = a0 + a1 + a2;
                2: g3_v7 = a0 - a1 + a2;
    ...
    function automatic logic signed [8:0] g2_v7(
        input logic signed [6:0] x0,
        input logic signed [6:0] x1,
        input integer o
    );
    ...
    //
    //   p0_b[0..47] : 5-bit weight storage
    //      Conv -> kernel at [0..24]
    ...
    function automatic integer lane_pw(input integer idx);
        begin
            case (idx)
                 0: lane_pw=19;  1: lane_pw=20;  2: lane_pw=20;  3: lane_pw=19;
                 4: lane_pw=20;  5: lane_pw=22;  6: lane_pw=21;  7: lane_pw=20;
                 8: lane_pw=20;  9: lane_pw=21; 10: lane_pw=21; 11: lane_pw=20;
                12: lane_pw=19; 13: lane_pw=20; 14: lane_pw=20; 15: lane_pw=19;
                16: lane_pw=18; 17: lane_pw=18; 18: lane_pw=18; 19: lane_pw=19;
                20: lane_pw=20; 21: lane_pw=19; 22: lane_pw=19; 23: lane_pw=19;
                24: lane_pw=19; 25: lane_pw=18; 26: lane_pw=18; 27: lane_pw=18;
                28: lane_pw=18; 29: lane_pw=19; 30: lane_pw=19; 31: lane_pw=18;
                32: lane_pw=18; 33: lane_pw=20; 34: lane_pw=19; 35: lane_pw=18;
                36: lane_pw=18; 37: lane_pw=19; 38: lane_pw=19; 39: lane_pw=18;
                40: lane_pw=17; 41: lane_pw=17; 42: lane_pw=17; 43: lane_pw=17;
                44: lane_pw=18; 45: lane_pw=17; 46: lane_pw=17; 47: lane_pw=17;
                default: lane_pw=17; // lane 48
            endcase
        end
    endfunction

    logic signed [13:0] p2_a_comb [0:48];
    logic signed [8:0] p2_b_comb [0:48];
    integer pj, pi;
    always_comb begin
        ...
        if (p1_is_fc) begin
            for (pi = 0; pi < 48; pi = pi + 1) begin
                ...
                p2_b_comb[pi] = {{2{p1_b[pi][6]}},p1_b[pi]};
            end
        end else begin
